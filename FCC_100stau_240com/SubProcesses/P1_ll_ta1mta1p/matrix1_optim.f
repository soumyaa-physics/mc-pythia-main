...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,4) /1,-1, 1, 0, 0/
      DATA (NHEL(I,2),I=0,4) /4, 1,-1, 0, 0/
      DATA IDEN/ 4/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
        ...
        IF(mdl_Wsl3.ne.0d0) then 
          fk_mdl_Wsl3 = SIGN(MAX(ABS(mdl_Wsl3), ABS(mdl_Msl3
     $     *small_width_treatment)), mdl_Wsl3) 
        else 
          fk_mdl_Wsl3 = 0d0
        endif
